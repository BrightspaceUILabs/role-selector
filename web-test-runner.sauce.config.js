...
const sauceLabsCapabilities = {
	name: '@brightspace-ui-labs/role-selector unit tests',
	// eslint-disable-next-line no-undef
	build: `@brightspace-ui-labs/role-selector ${process.env.GITHUB_REF ?? 'local'} build ${process.env.GITHUB_RUN_NUMBER ?? ''}`
};
